+++
title = "Somos 75% de Agua de Mar isotónica"
description = "Guía completa sobre Somos 75% de Agua de Mar isotónica - RexMar Agua de Mar"
date = 2023-12-13
author = "legar"
...
Como resultado de la dieta moderna, el cuerpo humano pierde minerales. Esta pérdida de minerales puede provocar una serie de problemas de salud, como:
...
El agua de mar isotónica es una excelente manera de recuperar los minerales perdidos. El agua de mar RexMar es un agua de mar que se obtiene siguiendo el protocolo de extracción y filtrado del célebre científico René Quinton.

El protocolo de extracción y filtrado de René Quinton consiste en extraer el agua de mar de zonas profundas (ver [último video](https://th.org.pe/) de extracción) y microfiltrar con filtro cerámico de 0,2 micras, para eliminar las impurezas terrestres. El resultado es un agua de mar pura y natural que contiene una concentración de sales minerales similar a la del plasma sanguíneo (9%) pero el Agua de Mar está 36% por eso la debemos rebajar (isotonizar) con agua común u otros liquidos que tomemos.

El agua de mar RexMar es una bebida natural y biodisponible que ayuda a remineralizar el cuerpo de forma segura y eficaz. Se puede tomar a diario, ya sea sola (hipertónica) o mezclada con otras bebidas (isotónica). Ver distintas formas de tomar: [/home/formas-de-uso-y-tips/](/home/formas-de-uso-y-tips/)

**Beneficios del agua de mar RexMar**

El agua de mar RexMar ofrece una serie de beneficios para la salud, entre los que se incluyen:
